...
import { search } from "../../features/teams/teamSlice";
...
const NavBar = () => {
  ...
  return (
    <div className="flex items-center flex-shrink-0 w-full h-16 px-10 bg-white bg-opacity-75">
      ...
      <div className="ml-10">
        <Link
          className="mx-2 text-sm font-semibold text-gray-600"
          to="/projects"
        >
          Projects
        </Link>
        <Link
          className="mx-2 text-sm font-semibold  text-indigo-600 hover:text-indigo-700"
          to="/teams"
        >
          Team
        </Link>
